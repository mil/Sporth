...
SPORTH_UGEN(".", sporth_add2, SPORTH_ADD2, 4, 2)
...
SPORTH_UGEN("ldu", sporth_ldu, SPORTH_LDU, 1, 1)
SPORTH_UGEN("lduserver", sporth_lduserver, SPORTH_LDUSERVER, 0, 0)
SPORTH_UGEN("loadfile2", sporth_loadfile2, SPORTH_LOADFILE2, 3, 0)
...
SPORTH_UGEN("m", sporth_muteable, SPORTH_MUTEABLE, 2, 1)
SPORTH_UGEN("m!", sporth_mutetrigger, SPORTH_MUTETRIGGER, 2, 1)
...
SPORTH_UGEN("smpldur", sporth_smpldur, SPORTH_SMPLDUR, 1, 1)
...
SPORTH_UGEN("stream", sporth_stream, SPORTH_STREAM, 1, 1)
